...
create table user_profile(
    ...
    nickname varchar(20), -- 닉네임 중복 허용 여부 어케할지??
    -- 사진도 넣어?ㅁㄹ
...
VALUES ('test01', 'dummy', '테스트', '2000-01-01', '010-0000-0000', 'test@test.com', 'M');
...
-- expenses
INSERT INTO expenses (id, category_id, memo, amount, spent_at)
VALUES ('test01', 1, '테스트 지출', 10000, '2025-07-01');